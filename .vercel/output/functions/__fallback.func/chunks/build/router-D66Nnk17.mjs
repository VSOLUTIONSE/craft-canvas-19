import { k as compileDecodeCharMap, c as createLRUCache, t as trimPath, l as rewriteBasepath, m as composeRewrites, p as processRouteTree, n as processRouteMasks, o as resolvePath, q as cleanPath, s as trimPathRight, g as createControlledPromise, u as parseHref, v as executeRewriteInput, w as isDangerousProtocol, x as redirect, b as isRedirect, d as isNotFound, y as findSingleMatch, z as deepEqual, D as DEFAULT_PROTOCOL_ALLOWLIST, A as interpolatePath, B as nullReplaceEqualDeep, C as replaceEqualDeep$1, E as last, F as decodePath, G as findFlatMatch, f as functionalUpdate$1, H as findRouteMatch, i as isPromise, e as invariant, h as rootRouteId, M as useRouter, r as reactExports, U as jsxRuntimeExports, $ as Outlet, I as executeRewriteOutput, J as encodePathLikeUrl, a as arraysEqual, T as React, R as exactPathTest, S as removeTrailingSlash, V as isModuleNotFoundError, j as isServer, N as dummyMatchContext, O as matchContext, X as escapeHtml, Y as isInlinableStylesheet, Z as getAssetCrossOrigin, W as useHydrated, K as trimPathLeft, L as joinPaths, _ as resolveManifestAssetLink, Q as requireReactDom, P as getDefaultExportFromCjs } from "./server.mjs";
...
const appCss = "/assets/styles-CLk7Y7n_.css";
...
const $$splitComponentImporter = () => import("./index-B4HOD9Ta.mjs");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "I turn AI into repeatable systems that save time, improve output quality, and make teams faster."
    }, {
      property: "og:title",
      content: "Favour Emmanuel — AI Prompt Engineer & LLM Trainer"
    }, {
      property: "og:description",
      content: "Prompt systems, LLM evaluation, AI workflow automation, and team training."
    }, {
      property: "og:type",
      content: "website"
    }, {
